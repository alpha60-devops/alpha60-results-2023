...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2023/refs/heads/main/data/geojson.cumulative/avatar-the-way-of-water-cumulative-aggregate.geojson.gz" data-map-title="Avatar: The Way of Water — avatar-the-way-of-water" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Avatar: The Way of Water (avatar-the-way-of-water) cumulative data map in new window" title="Opens interactive map for Avatar: The Way of Water (avatar-the-way-of-water) data">Swarm Detail</a>
