...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2023/refs/heads/main/data/geojson.cumulative/no-more-bets-cumulative-aggregate.geojson.gz" data-map-title="No More Bets — no-more-bets" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open No More Bets (no-more-bets) cumulative data map in new window" title="Opens interactive map for No More Bets (no-more-bets) data">Swarm Detail</a>
