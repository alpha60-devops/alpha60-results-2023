...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2023/refs/heads/main/data/geojson.cumulative/fargo-501-cumulative-aggregate.geojson.gz" data-map-title="Fargo — fargo-501" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Fargo (fargo-501) cumulative data map in new window" title="Opens interactive map for Fargo (fargo-501) data">Swarm Detail</a>
