...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2023/refs/heads/main/data/geojson.cumulative/witcher-03.1-cumulative-aggregate.geojson.gz" data-map-title="Witcher — witcher-03.1" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Witcher (witcher-03.1) cumulative data map in new window" title="Opens interactive map for Witcher (witcher-03.1) data">Swarm Detail</a>
