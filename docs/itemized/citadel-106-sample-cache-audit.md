...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2023/refs/heads/main/data/geojson.cumulative/citadel-106-cumulative-aggregate.geojson.gz" data-map-title="Citadel — citadel-106" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Citadel (citadel-106) cumulative data map in new window" title="Opens interactive map for Citadel (citadel-106) data">Swarm Detail</a>
