...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2023/refs/heads/main/data/geojson.cumulative/barbie-cumulative-aggregate.geojson.gz" data-map-title="Barbie — barbie" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Barbie (barbie) cumulative data map in new window" title="Opens interactive map for Barbie (barbie) data">Swarm Detail</a>
