...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2023/refs/heads/main/data/geojson.cumulative/beacon-23-108-cumulative-aggregate.geojson.gz" data-map-title="Beacon 23 — beacon-23-108" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Beacon 23 (beacon-23-108) cumulative data map in new window" title="Opens interactive map for Beacon 23 (beacon-23-108) data">Swarm Detail</a>
